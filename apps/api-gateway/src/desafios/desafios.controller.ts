...
export class DesafiosController {
    ...
    private clientSmartRanking: ClientProxySmartRanking;
    private clientDesafios: ClientProxy;
    private clientAdminBackend: ClientProxy;

    constructor(
      clientProxySmartRanking: ClientProxySmartRanking
    ) {
        this.clientSmartRanking = clientProxySmartRanking;
        this.clientDesafios = this.clientSmartRanking.getClientProxyDesafiosInstance()
        this.clientAdminBackend = this.clientSmartRanking.getClientProxyAdminBackendInstance() 
    }
